...
namespace UTF8 {
    ...
    public:
		...
		/**
         * Create string object filled with type char
         */
		String(int size, char type);
		...
		/**
		 * Converts UTF8::String to char *
		 */
		char* ToCharPtr() { return Data; }
		...
		/**
         * Insert text peace and returns result
         * @param Start position to insert
         * @param Insert String to insert
         * @return Returns result of replacement
         */
        String Insert(unsigned int Start, const String &Insert) const;
